...
[
  ...
  {"credit_with_frame_count", [Protocol.frame_tag(:credit), 7, 4_194_304, 12]},
  {"credit_initial_grant", [Protocol.frame_tag(:credit), 7, 4_194_304, 0]},
  {"stream_data_text", [Protocol.frame_tag(:stream_data), 7, "chunk"]},
  {"stream_data_empty_chunk", [Protocol.frame_tag(:stream_data), 7, %Bin{data: <<>>}]},
  {"stream_data_structured_chunk",
   [Protocol.frame_tag(:stream_data), 7, %{"seq" => 3, "body" => %Bin{data: <<9, 9>>}}]},
  {"half_close_high_stream_id", [Protocol.frame_tag(:half_close), 18_446_744_073_709_551_615]},
